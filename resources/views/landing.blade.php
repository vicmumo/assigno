  ...
  <body>
    ...
    <header id="home" class="hero-area">    
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <a href="#" class="navbar-brand"><img src="" alt="">Assigno</a>       
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#services">Why Us?</a>
              </li>  
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#features">Need Content</a>
              </li>      
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#pricing">Hire Me</a>
              </li>   
              <li class="nav-item">
      ...
      <div class="container">      
        <div class="row space-100">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12 p-0">
            <div class="intro-img">
              <img src="landing/img/intro.png" alt="">
            </div>            
          </div>
        </div> 
      </div>             
